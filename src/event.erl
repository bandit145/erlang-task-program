...
%% Loop uses a list for times in order to get around erlang limit
...
%% Because erlang is limited to about 49 days in milliseconds, the following functions is used
normalize(N) ->
	Limit = 49*24*60*60,
